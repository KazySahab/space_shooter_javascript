document.addEventListener("keydown", function (input) {
    console.log(input);
    if (input.code == "KeyW") player.velocity.y = -0.4;
    if (input.code == "KeyS") player.velocity.y = 0.4;
    if (input.code == "KeyA") player.velocity.x = -0.4;
    if (input.code == "KeyD") player.velocity.x = 0.4;
    if (input.code == "Space")
    {
